...
class TestCurrentTask:
    ...
    def test_current_task_with_in_progress_task(self, client, tmp_team):
        ...
        task = create_task(tmp_team, title="Build the widget")
    ...
    def test_current_task_null_for_open_task(self, client, tmp_team):
        ...
        task = create_task(tmp_team, title="Pending task")
        assign_task(tmp_team, task["id"], "bob")
    ...
    def test_current_task_null_after_review(self, client, tmp_team):
        ...
        task = create_task(tmp_team, title="Review me")
        assign_task(tmp_team, task["id"], "alice")
        change_status(tmp_team, task["id"], "in_progress")
    ...
    def test_current_task_structure(self, client, tmp_team):
        ...
        task = create_task(tmp_team, title="Structured task")
        assign_task(tmp_team, task["id"], "bob")
        change_status(tmp_team, task["id"], "in_progress")
    ...
    def test_other_agents_unaffected(self, client, tmp_team):
        ...
        task = create_task(tmp_team, title="Alice's task")
        assign_task(tmp_team, task["id"], "alice")
        change_status(tmp_team, task["id"], "in_progress")
